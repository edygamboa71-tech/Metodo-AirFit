...
export default function SocialProof({ onNext, onBack, lang }: SocialProofProps) {
      ...
      <main className="w-full max-w-[600px] px-6 py-8 flex flex-col items-center">
        ...
        >
          <h1 className="text-[28px] md:text-[32px] font-bold leading-tight mb-8">
            {t.socialProof.title.split('500,000')[0]}<span className="text-primary">500,000</span>{t.socialProof.title.split('500,000')[1]}
          </h1>
          ...
          <div className="grid grid-cols-2 gap-4 mb-10">
            <div className="bg-white p-3 rounded-[16px] shadow-sm border border-gray-100">
              ...
              <p className="text-[11px] font-bold text-text-main">{t.socialProof.testimonial1}</p>
            </div>
            ...
            <div className="bg-white p-3 rounded-[16px] shadow-sm border border-gray-100">
              ...
              <p className="text-[11px] font-bold text-text-main">{t.socialProof.testimonial2}</p>
            </div>
          </div>
