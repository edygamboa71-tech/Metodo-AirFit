          ...
          <div className="flex flex-col gap-2 w-full">
            {t.steps.motivation.options.map((option) => (
              <button
                ...
                className="group w-full min-h-[64px] px-6 py-3 bg-[#F5F5F5] rounded-[16px] flex items-center justify-between transition-all text-left hover:bg-primary/5 hover:border-primary/20 border-2 border-transparent"
              >
