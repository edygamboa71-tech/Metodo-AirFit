...
export default function ComparisonStep({ onNext, onBack }: ComparisonStepProps) {
  return (
          ...
          <div className="w-full bg-white rounded-[24px] p-8 shadow-xl shadow-black/5 mb-10 flex flex-col items-center border border-gray-100">
            ...
            <div className="w-full flex items-end justify-around h-[200px] mb-8 px-4">
              ...
              <div className="flex flex-col items-center w-24">
                <div className="text-red-500 font-black text-lg mb-2">1-2kg</div>
                <motion.div 
                  initial={{ height: 0 }}
                  animate={{ height: '40px' }}
              ...
              {/* AirFit Bar */}
              <div className="flex flex-col items-center w-24">
                <div className="text-green-500 font-black text-lg mb-2">3-8kg</div>
                <motion.div 
                  initial={{ height: 0 }}
